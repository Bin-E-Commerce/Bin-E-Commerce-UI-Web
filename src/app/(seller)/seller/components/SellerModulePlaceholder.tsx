        ...
        <div className="min-w-0 space-y-4 sm:space-y-6">
            ...
            <section className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2 xl:grid-cols-3">
                <div className="min-w-0 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm sm:p-5">
                    ...
                    <p className="mt-2 text-sm leading-6 text-zinc-600">
                        Trạng thái công việc sẽ được sắp xếp theo mức độ ưu tiên
                        để bạn biết việc nào cần xử lý trước.
                    </p>
                </div>
                <div className="min-w-0 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm sm:p-5">
                    <CheckCircle2
                    ...
                    <p className="mt-2 text-sm leading-6 text-zinc-600">
                        Bộ lọc, bảng dữ liệu và hành động thường dùng sẽ được bố
                        trí ngay trong màn hình này.
                    </p>
                </div>
                <div className="min-w-0 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm md:col-span-2 sm:p-5 xl:col-span-1">
                    ...
                    <p className="mt-2 text-sm leading-6 text-zinc-600">
                        Bố cục tự thích ứng để bạn có thể theo dõi và xử lý công
                        việc trên máy tính bảng hoặc điện thoại.
                    </p>
                </div>
            </section>
        </div>
