        ...
        <div className="grid gap-6 xl:grid-cols-[1fr_280px]">
            <div className="grid gap-5 sm:grid-cols-2">
                ...
                <Field
                    ...
                    htmlFor="province"
                    error={
                        errors['pickupAddress.provinceId'] ?? error ?? undefined
                    }
                    required
                >
                    <SellerCombobox
                ...
                <Field
                    label="Quận / Huyện"
                    htmlFor="district"
                    error={errors['pickupAddress.districtId']}
                    required
                >
                    <SellerCombobox
                        id="district"
                ...
                <div className="sm:col-span-2">
                    <Field
                        label="Phường / Xã"
                        htmlFor="ward"
                        error={errors['pickupAddress.wardCode']}
                        required
                    >
                        <SellerCombobox
                            id="ward"
                ...
                <div className="sm:col-span-2">
                    ...
                    >
                        <textarea
                            ...
                            placeholder="Số nhà, tên đường, ghi chú lấy hàng nếu có."
                            onChange={(event) =>
            ...
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">
                    Địa chỉ GHN này được dùng để tính phí và tạo vận đơn cho
                    shop.
                </p>
            </div>
        </div>
