        ...
        <section className="rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-7">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-zinc-500">
                            Môi trường kiểm thử do platform quản lý, không cần
                            Seller nhập token.
                        </p>
                    </div>
                </div>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl bg-zinc-50 p-4">
                    ...
                    <p className="mt-1 text-xs leading-5 text-zinc-500">
                        Tính theo từng shop tại checkout.
                    </p>
                </div>
                <div className="rounded-2xl bg-zinc-50 p-4">
                ...
                <div className="rounded-2xl bg-zinc-50 p-4">
                    ...
                    <p className="mt-1 text-xs leading-5 text-zinc-500">
                        Đồng bộ trạng thái và hủy đủ điều kiện.
                    </p>
                </div>
            </div>

            <p className="mt-5 border-t border-zinc-200 pt-5 text-sm leading-6 text-zinc-500">
                Staging chỉ phục vụ kiểm thử request/response và luồng vận hành,
                không tạo giao hàng thật.
            </p>
            ...
            <div className="mt-5 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 sm:p-5">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-zinc-950">
                            Cấu hình để shop hoạt động
                        </p>
                        <p className="mt-1 text-sm leading-5 text-zinc-500">
                            Seller không nhập token. Credential GHN được quản lý
                            tập trung ở Shipping Service.
                        </p>
                    </div>
                </div>
                ...
                <ol className="mt-4 grid gap-3 sm:grid-cols-2">
                    <li className="flex gap-3 rounded-xl border border-zinc-200 bg-white p-3">
                        ...
                        <p className="text-xs leading-5 text-zinc-600">
                            Thêm địa chỉ lấy hàng và chọn một địa chỉ làm mặc
                            định.
                        </p>
                    </li>
                    <li className="flex gap-3 rounded-xl border border-zinc-200 bg-white p-3">
                        ...
                        <p className="text-xs leading-5 text-zinc-600">
                            Lưu thời gian chuẩn bị và khung giờ GHN đến nhận
                            hàng.
                        </p>
                    </li>
                    <li className="flex gap-3 rounded-xl border border-zinc-200 bg-white p-3">
                        ...
                        <p className="text-xs leading-5 text-zinc-600">
                            Quản trị viên cấu hình credential GHN Test trên
                            server.
                        </p>
                    </li>
                    <li className="flex gap-3 rounded-xl border border-zinc-200 bg-white p-3">
                        ...
                        <p className="text-xs leading-5 text-zinc-600">
                            Tải lại trang rồi thử tính phí hoặc tạo vận đơn.
                        </p>
                    </li>
                </ol>
                ...
                <div className="mt-4 flex items-start gap-2.5 border-t border-zinc-200 pt-4 text-xs leading-5 text-zinc-500">
                    ...
                    />
                    <p>
                        Thiếu credential sẽ khiến quote và tạo vận đơn bị tạm
                        dừng; đây là lỗi cấu hình platform, không phải lỗi địa
                        chỉ người mua.
                    </p>
                </div>
            </div>
