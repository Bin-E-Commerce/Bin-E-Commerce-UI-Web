...
export function ShippingProviderWorkflowCard({
    hasDefaultPickupAddress,
}: ShippingProviderWorkflowCardProps) {
    return (
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm leading-6 text-zinc-500">
                            Cần có địa chỉ mặc định để tính phí và tạo vận đơn.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-zinc-950">
                                {hasDefaultPickupAddress
                                    ? 'Đã chọn địa chỉ mặc định'
                                    : 'Chưa chọn địa chỉ mặc định'}
                            </p>
                            <p className="mt-1 text-xs leading-5 text-zinc-500">
                                {hasDefaultPickupAddress
                                    ? 'Địa chỉ này được dùng khi tạo báo giá và vận đơn.'
                                    : 'Hãy bổ sung địa chỉ trước khi shop nhận đơn mới.'}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-5 ml-4 border-l border-zinc-200">
                    ...
                    <div className="relative -ml-4 flex gap-3 pb-5">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs leading-5 text-zinc-500">
                                Thao tác sau khi chuẩn bị hàng.
                            </p>
                        </div>
                    </div>
                    <div className="relative -ml-4 flex gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-xs leading-5 text-zinc-500">
                                Webhook và polling cập nhật tracking.
                            </p>
                        </div>
                    </div>
                </div>
