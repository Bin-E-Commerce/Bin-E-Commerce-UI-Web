...
export default function ShippingProvidersPage() {
    ...
    const preparationTimeHours =
        preparationTime ?? String(current?.settings.preparationTimeHours ?? 24);
    const pickupWindowValue =
        pickupWindow ??
        `${formatTimeLabel(current?.settings.pickupWindowStart, '08:00')} - ${formatTimeLabel(current?.settings.pickupWindowEnd, '18:00')}`;
    ...
    if (settingsQuery.isError || !current) {
        return (
            <section className="rounded-2xl border border-red-200 bg-red-50 p-8 text-center">
                ...
                <h1 className="mt-3 font-semibold text-red-950">
                    Không thể tải cấu hình vận chuyển
                </h1>
                ...
                <Button
                    variant="outline"
                    className="mt-5 cursor-pointer border-red-200 bg-white"
    ...
    return (
        <div className="min-w-0 pb-10">
            ...
            <header className="mt-5 rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-7 lg:p-8">
                    ...
                    <div className="flex min-w-0 items-start gap-4">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-500">
                                Một nơi để kiểm tra kết nối GHN và thiết lập
                                lịch bàn giao của shop.
                            </p>
                        </div>
                    </div>
                    <div className="flex w-full shrink-0 items-center gap-3 rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 lg:w-auto">
                ...
                <nav
                    aria-label="Các bước cấu hình vận chuyển"
                    className="mt-6 grid gap-2 border-t border-zinc-200 pt-5 sm:grid-cols-3"
                >
                    <a
                        href="#connection"
                        className="flex items-center gap-3 rounded-xl px-3 py-2 transition hover:bg-zinc-50"
                    >
                        <span className="flex size-8 items-center justify-center rounded-full bg-zinc-950 text-xs font-bold text-white">
                            01
                        </span>
                        <span>
                    ...
                    <a
                        ...
                        className="flex items-center gap-3 rounded-xl px-3 py-2 transition hover:bg-zinc-50"
                    >
                        <span className="flex size-8 items-center justify-center rounded-full bg-zinc-100 text-xs font-bold text-zinc-700">
                            02
                        </span>
                        <span>
                            <span className="block text-sm font-semibold text-zinc-950">
            ...
            <main className="mt-6 w-full">
                <div className="grid min-w-0 items-start gap-6 lg:grid-cols-[minmax(0,1.75fr)_minmax(280px,0.85fr)] xl:grid-cols-[minmax(0,1.9fr)_340px]">
                    <div className="min-w-0 space-y-5">
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <span className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-zinc-950 text-sm font-bold text-white">
                                    02
                                </span>
                                <div>
                                    ...
                                    <h2 className="mt-1 text-xl font-semibold tracking-tight text-zinc-950">
                                        Lịch chuẩn bị và nhận hàng
                                    </h2>
                                    <p className="mt-1 text-sm leading-6 text-zinc-500">
                                        Cài đặt thời gian để Seller chủ động
                                        chuẩn bị trước khi đơn vị vận chuyển đến
                                        nhận hàng.
                                    </p>
                                </div>
                            </div>
                    ...
                    <aside id="workflow" className="min-w-0">
                        <ShippingProviderWorkflowCard
                            hasDefaultPickupAddress={hasDefaultPickupAddress}
                        />
                    </aside>
                </div>
            </main>
