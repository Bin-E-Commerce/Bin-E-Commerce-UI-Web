    ...
    return (
        <div className="mt-6">
            <div className="grid gap-5 sm:grid-cols-2">
                <label className="block text-sm font-medium text-zinc-700">
                    ...
                    <span className="mt-1.5 block text-xs font-normal text-zinc-500">
                        Thời gian shop cần để đóng gói trước khi bàn giao.
                    </span>
                </label>
                ...
                <label className="block text-sm font-medium text-zinc-700">
                    ...
                    <input
                        ...
                        value={pickupWindow}
                        onChange={(event) =>
                            onPickupWindowChange(event.target.value)
                        }
                        placeholder="08:00 - 18:00"
                    />
                    <span className="mt-1.5 block text-xs font-normal text-zinc-500">
                        Khoảng thời gian đơn vị vận chuyển đến nhận hàng.
                    </span>
                </label>
            </div>
            ...
            <div className="mt-5 flex items-start gap-3 rounded-2xl border border-zinc-200 bg-zinc-50 p-4 text-sm leading-6 text-zinc-600">
                ...
                <p>
                    Phí giao hàng được tính theo từng shop tại checkout, sau khi
                    khách chọn địa chỉ nhận.
                </p>
            </div>
            ...
            <div className="mt-5 flex flex-col gap-3 border-t border-zinc-200 pt-5 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-xs leading-5 text-zinc-500">
                    Cấu hình có thể cập nhật bất cứ lúc nào.
                </p>
                <Button
