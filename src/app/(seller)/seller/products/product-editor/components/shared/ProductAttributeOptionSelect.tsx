...
export function ProductAttributeOptionSelect({
    value,
    options,
    multiple,
    maxSelections,
        ...
        <Popover open={open} onOpenChange={setOpen}>
                ...
                >
                    <span
                        className={cn(
                            ...
                            selectedIds.length === 0 && 'text-zinc-500',
                        )}
                    >
                        {selectedLabel}
                    </span>
            ...
            >
                ...
                {multiple && maxSelections ? (
                    <p className="px-1 pb-1 pt-2 text-xs text-zinc-500">
                        Đã chọn {selectedIds.length}/{maxSelections} giá trị
                    </p>
                ) : null}
                        ...
                        filteredOptions.map((option) => {
                            ...
                            return (
                                <Button
                                    ...
                                    className={cn(
                                        'flex min-h-9 w-full items-center justify-between rounded-sm px-2 text-left text-sm transition-colors hover:bg-zinc-100 disabled:cursor-not-allowed disabled:opacity-40',
                                        selected &&
