    ...
    return (
        <aside className="rounded-md border border-zinc-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-sm leading-6 text-zinc-600">
                Hoàn thiện các điều kiện nền tảng để sản phẩm dễ tìm, rõ ràng và
                đáng tin cậy hơn.
            </p>
            ...
            <div className="mt-5 space-y-5">
                <section>
                    ...
                    <ul className="mt-1.5 space-y-1.5">
                        <QualityItem
                            status={imageCount >= 2 ? 'complete' : 'pending'}
                        >
                            Tải lên ít nhất 2 hình ảnh sản phẩm.
                        </QualityItem>
                    </ul>
                    <p className="mt-3 text-xs font-medium text-zinc-500">
                        Tự rà soát trước khi đăng
                    </p>
                    <ul className="mt-1.5 space-y-1.5">
                        <QualityItem status="manual">
                            Ảnh đúng tỷ lệ, hiển thị đầy đủ sản phẩm và không có
                            viền trắng.
                        </QualityItem>
                        <QualityItem status="manual">
                            Ảnh rõ nét, nền gọn; không để watermark che mất sản
                            phẩm.
                        </QualityItem>
                    </ul>
                </section>
                ...
                <section className="border-t border-zinc-100 pt-4">
                    ...
                    <ul className="mt-1.5 space-y-1.5">
                        <QualityItem
                            status={titleLength >= 20 ? 'complete' : 'pending'}
                        >
                            Có ít nhất 20 ký tự.
                        </QualityItem>
                    </ul>
                    ...
                    <ul className="mt-1.5 space-y-1.5">
                        <QualityItem status="manual">
                            Nêu đúng sản phẩm hoặc thương hiệu; không lặp từ
                            khóa, dùng từ phóng đại hay nội dung không liên
                            quan.
                        </QualityItem>
                    </ul>
                </section>
                ...
                <section className="border-t border-zinc-100 pt-4">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <span
                            className={cn(
                                'text-xs font-semibold tabular-nums',
                                descriptionLength >= 100 || imageCount > 0
                                    ? 'text-emerald-700'
                                    : 'text-zinc-500',
                            )}
                        >
                    ...
                    <ul className="mt-2 space-y-1.5">
                        ...
                        >
                            Có ít nhất 100 ký tự mô tả hoặc ít nhất 1 hình ảnh
                            minh họa.
                        </QualityItem>
                    </ul>
                </section>
                ...
                <section className="border-t border-zinc-100 pt-4">
                    ...
                    <ul className="mt-2 space-y-1.5">
                        <QualityItem status={hasVideo ? 'complete' : 'pending'}>
                            Đăng tải video sản phẩm dài từ 10 đến 60 giây.
                        </QualityItem>
                    </ul>
                </section>
            </div>
