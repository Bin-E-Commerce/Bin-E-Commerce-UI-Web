        ...
        <div className="space-y-6">
                ...
                <div className="grid gap-0 lg:grid-cols-[1.4fr_0.9fr]">
                    <div className="p-6 sm:p-8">
                        ...
                        <h1 className="mt-3 max-w-2xl text-3xl font-semibold tracking-tight text-zinc-950">
                            Quản trị shop, đơn hàng và doanh thu trong một không
                            gian tập trung.
                        </h1>
                        <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-600">
                            Theo dõi việc cần xử lý trong ngày, kiểm soát tồn
                            kho và nắm hiệu suất bán hàng mà không phải chuyển
                            qua nhiều màn hình rời rạc.
                        </p>
            ...
            <section className="grid gap-4 xl:grid-cols-[1.4fr_0.8fr]">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-zinc-500">
                                Các đầu việc ảnh hưởng trực tiếp đến trải nghiệm
                                khách hàng.
                            </p>
                        </div>
                ...
                <div className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-1 text-sm text-zinc-500">
                        Tạm thời chưa có dữ liệu vận hành. Khi shop hoạt động,
                        điểm chất lượng sẽ hiển thị ở đây.
                    </p>
