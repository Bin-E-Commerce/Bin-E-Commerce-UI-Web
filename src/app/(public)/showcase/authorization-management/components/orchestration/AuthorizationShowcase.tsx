                ...
                <div className="grid min-w-0 gap-6 xl:grid-cols-[minmax(0,1fr)_16rem] xl:items-start">
                    ...
                    >
                        <ShowcaseFeatureHeader
                            ...
                            title="Phân quyền rõ ràng, kiểm soát đến từng tài nguyên"
                            variant="light"
                            density="compact"
                            asideContent={
                                <ShowcaseReadingGuide
                                    ariaLabel="Lộ trình đọc tài liệu Authorization Management"
                                    items={[
                                        {
                                            href: '#authorization-request-overview',
                                            title: 'Luồng request',
                                            summary:
                                                'Từ identity đến quyết định',
                                        },
                                        {
                                            href: '#authorization-architecture',
                                            title: 'Kiến trúc hệ thống',
                                            summary:
                                                'Gateway, policy và access profile',
                                        },
                                        {
                                            href: '#authorization-logic',
                                            title: 'Logic xử lý',
                                            summary: 'Năm điểm kiểm soát chính',
                                        },
                                    ]}
                                />
                            }
                        ...
                        <ShowcaseTableOfContents
                            variant="mobile"
                            items={authorizationTableOfContents}
                        />
                        ...
                        <section
                            ...
                            aria-label="Tài liệu kiến trúc và logic Authorization Management"
                        >
                            <header className="grid gap-2 border-b border-zinc-200 pb-4 sm:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] sm:items-end sm:gap-6">
                                ...
                                <p className="text-sm leading-6 text-zinc-600">
                                    Đi từ nơi policy được resolve đến cách quyền
                                    được enforce, cache và truy vết.
                                </p>
                            </header>
                            <div className="grid gap-4">
                                <ShowcaseDisclosure
                                    ...
                                    number="1"
                                    title="Kiến trúc hệ thống"
                                    description="Auth Service sở hữu policy; Gateway truyền context đã xác thực; downstream service kiểm tra ownership trước mutation."
                                >
                                ...
                                <ShowcaseDisclosure
                                    ...
                                    number="2"
                                    title="Logic xử lý"
                                    description="Năm điểm kiểm soát giải thích cách request được cấp quyền, policy được cập nhật và access profile được làm mới."
                                >
                                    <AuthorizationLogicOverview />
                                </ShowcaseDisclosure>
                            </div>
                        </section>
                    </main>
