...
export function ShowcaseLogicLink({ href }: ShowcaseLogicLinkProps) {
    return (
        <a
            ...
            className="group inline-flex min-h-6 shrink-0 items-center gap-1 text-[10px] font-medium text-zinc-600 underline decoration-zinc-300 underline-offset-4 transition-colors hover:text-zinc-950 hover:decoration-zinc-500"
        >
            <span>Xem logic</span>
            <ArrowDownRight
                aria-hidden="true"
