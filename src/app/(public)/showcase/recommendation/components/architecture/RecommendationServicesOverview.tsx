        ...
        >
            <div className="space-y-4">
                ...
                >
                    <ol className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                        ...
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                Chuyển tiếp request/event cùng identity user
                                hoặc session; không tự tạo hay xếp hạng gợi ý.
                            </p>
                        </li>
                        ...
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                Đọc cache/ngữ cảnh, gom ứng viên, xếp hạng và
                                trả sản phẩm kèm nguồn, lý do, attribution.
                            </p>
                        </li>
                        ...
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                Dự đoán điểm cho AI-Enhanced; nếu prediction
                                không dùng được, Recommendation quay về
                                Standard.
                            </p>
                        </li>
                    </ol>
                ...
                >
                    <ul className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                Gửi lượt xem, click, tìm kiếm và thêm giỏ vào
                                luồng ghi nhận hành vi.
                            </p>
                        </li>
                        ...
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                Phát thay đổi sản phẩm; Recommendation đồng bộ
                                vào catalog read model riêng.
                            </p>
                        </li>
                        ...
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                Phát đơn hoàn tất/hoàn trả qua outbox để tín
                                hiệu mua dựa trên giao dịch đã xác nhận.
                            </p>
                        </li>
                        ...
                        <li className="flex h-full min-w-0 flex-col rounded-xl border border-zinc-200 bg-white p-4 shadow-sm shadow-zinc-950/[0.03]">
                            ...
                            <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                                ...
                                profile/session và quan hệ sản phẩm cho request
                                sau.
                            </p>
                        </li>
                    </ul>
                ...
                <p className="mt-3 rounded-xl border border-zinc-200 bg-white px-3 py-2.5 text-[11px] leading-4 text-zinc-600">
                    ...
                    Catalog read model và Kafka consumer là module/worker bên
                    trong Recommendation Service, không phải microservice độc
                    lập. Request gợi ý đọc dữ liệu đã đồng bộ, không truy cập
                    trực tiếp database của Product hoặc Order.
                </p>
            </div>
        </RecommendationDisclosure>
    );
