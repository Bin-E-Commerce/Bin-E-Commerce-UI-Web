    ...
    return (
        <section className="space-y-5">
            ...
            >
                    ...
                    <article className="flex h-full flex-col rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5">
                        ...
                        <dl className="mt-3 grid flex-1 gap-x-4 gap-y-3 sm:grid-cols-2">
                            <SignalFact label="Vì sao dùng">
                                Giữ sở thích đã tích lũy theo user; khách chưa
                                đăng nhập vẫn có profile theo session, nhưng
                                không thành hồ sơ xuyên phiên.
                            </SignalFact>
                            <SignalFact label="Cách hình thành">
                                Consumer xử lý event rồi cộng/trừ preference
                                theo sản phẩm, danh mục và thương hiệu; cập nhật
                                bất đồng bộ sau request.
                            </SignalFact>
                            <SignalFact label="Áp dụng vào đâu">
                                Bước tạo ứng viên lấy tối đa 30 sản phẩm, 12
                                danh mục, 12 thương hiệu có điểm dương. Điểm âm
                                được giữ riêng để ranking áp penalty; giới hạn
                                này giữ phần đọc/tính điểm gọn.
                            </SignalFact>
                            <SignalFact label="Trade-off">
                                Top 30/12/12 bỏ bớt sở thích yếu để giới hạn
                                query/feature; tăng thì tốn đọc/chấm điểm, giảm
                                thì mất độ phủ. Half-life mặc định 7 ngày làm
                                điểm giảm một nửa mỗi tuần: đổi dần, không tức
                                thì.
                            </SignalFact>
                        </dl>
                    </article>
                    ...
                    <article className="flex h-full flex-col rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5">
                        ...
                        <dl className="mt-3 grid flex-1 gap-x-4 gap-y-3 sm:grid-cols-2">
                            <SignalFact label="Vì sao dùng">
                                ...
                                chưa đăng nhập hoặc hồ sơ dài hạn nói về nhóm
                                hàng khác.
                            </SignalFact>
                            <SignalFact label="Cách lưu">
                                Giữ sản phẩm, danh mục, thương hiệu, từ khóa và
                                giỏ hàng gần đây; tối đa 30 sản phẩm, TTL mặc
                                định 24 giờ.
                            </SignalFact>
                            <SignalFact label="Áp dụng vào đâu">
                                Danh mục/thương hiệu phiên mở rộng nguồn
                                catalog; sản phẩm đang xem và gần đây làm anchor
                                semantic/co-behavior; ranking nhận feature
                                sessionContext.
                            </SignalFact>
                            <SignalFact label="Trade-off">
                                30 sản phẩm/24 giờ là mặc định để giữ mạch mua
                                sắm mà không giữ session vô hạn; ngắn hơn dễ
                                quên ý định, dài hơn dễ bám ngữ cảnh cũ.
                                Impression không thành anchor; raw query được
                                lưu nhưng chưa trực tiếp lọc candidate/chấm
                                điểm.
                            </SignalFact>
                        </dl>
                    </article>
                    ...
                    <div className="border-b border-zinc-200 py-3">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                            ...
                            <p className="max-w-xl text-xs leading-5 text-zinc-600">
                                Hồ sơ là sở thích đã tích lũy; phiên là sản phẩm
                                hoặc danh mục người mua đang xem lúc này.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid gap-4 py-4 md:grid-cols-3 md:divide-x md:divide-zinc-200">
                        <article className="flex h-full flex-col md:pr-4">
                            ...
                            <p className="mt-1 text-xs leading-5 text-zinc-600">
                                Ưu tiên sở thích đã tích lũy; hoạt động trong
                                phiên và nguồn catalog vẫn có thể bổ sung sản
                                phẩm.
                            </p>
                        ...
                        <article className="flex h-full flex-col md:px-4">
                            ...
                            <p className="mt-1 text-xs leading-5 text-zinc-600">
                                ...
                                phẩm hoặc danh mục? Dùng hoạt động trong phiên
                                làm tín hiệu, kể cả với khách chưa đăng nhập.
                            </p>
                            <div className="mt-auto flex flex-wrap gap-1.5 pt-4">
                                <span className="rounded-full border border-zinc-200 bg-white px-2 py-1 text-[10px] text-zinc-600">
                                    Sản phẩm vừa xem
                        ...
                        <article className="flex h-full flex-col md:pl-4">
                            <div className="flex items-center justify-between gap-3">
                                <span className="inline-flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-500">
                                    ...
                                    Chưa có sở thích · chưa có hoạt động phiên
                                </span>
                                <Compass
                                    aria-hidden="true"
                                    className="size-4 text-zinc-400"
                            ...
                            <p className="mt-1 text-xs leading-5 text-zinc-600">
                                Tạo danh sách mở đầu từ hàng bán chạy, hàng mới
                                và khám phá; xu hướng vẫn được bổ sung riêng.
                            </p>
                            <div className="mt-auto flex flex-wrap gap-1.5 pt-4">
                                <span className="rounded-full border border-zinc-200 bg-white px-2 py-1 text-[10px] text-zinc-600">
                                    Bán chạy
                ...
                <aside className="rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5">
                    <div className="border-b border-zinc-200 py-3">
                        ...
                        <p className="mt-1 text-xs leading-5 text-zinc-600">
                            Người mua thường xem giày nhưng hôm nay lại xem máy
                            pha cà phê. Hệ thống giữ cả hai tín hiệu để tìm ứng
                            viên liên quan.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-2 py-3 sm:grid-cols-[1fr_auto_1fr_auto_1.2fr] sm:items-center">
                        ...
                        <div className="border-t border-zinc-200 py-2 sm:border-l sm:border-t-0 sm:pl-3">
                            ...
                            <p className="mt-1 text-[10px] leading-4 text-zinc-600">
                                Event vừa phát sinh chỉ ảnh hưởng request sau
                                khi consumer xử lý.
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid gap-3 py-4 sm:grid-cols-2 xl:grid-cols-3">
                    <article className="flex h-full flex-col rounded-xl border border-zinc-200 bg-white p-4">
                        <div className="flex items-center gap-2">
                            <span className="grid size-7 shrink-0 place-items-center rounded-lg border border-zinc-200 bg-white font-mono text-[11px] font-semibold text-zinc-700">01</span>
                            <h5 className="text-sm font-semibold text-zinc-950">Lấy lượt xem làm mốc</h5>
                        </div>
                        ...
                        <p className="mt-3 rounded-lg bg-zinc-50 px-3 py-2 text-xs text-zinc-700">
                            <strong className="font-mono text-base font-semibold text-zinc-950">+1</strong>
                    ...
                    <article className="flex h-full flex-col rounded-xl border border-zinc-200 bg-white p-4">
                        <div className="flex items-center gap-2">
                            <span className="grid size-7 shrink-0 place-items-center rounded-lg border border-zinc-200 bg-white font-mono text-[11px] font-semibold text-zinc-700">02</span>
                            <h5 className="text-sm font-semibold text-zinc-950">Ý định càng rõ, điểm càng cao</h5>
                        </div>
                        <p className="mt-2 flex-1 text-xs leading-5 text-zinc-600">
                        ...
                        <div className="mt-3 rounded-lg bg-zinc-50 px-3 py-2">
                            <p className="flex flex-wrap items-center gap-x-2 font-mono text-sm font-semibold text-zinc-950">
                                <span>0,05</span><span className="text-zinc-400">→</span>
                                <span>2</span><span className="text-zinc-400">→</span>
                                <span>4</span><span className="text-zinc-400">→</span>
                                <span>8</span>
                            </p>
                            <p className="mt-1 text-[10px] leading-4 text-zinc-500">Hiển thị → click → giỏ → mua</p>
                        </div>
                    </article>
                    <article className="flex h-full flex-col rounded-xl border border-zinc-200 bg-white p-4">
                        <div className="flex items-center gap-2">
                            <span className="grid size-7 shrink-0 place-items-center rounded-lg border border-zinc-200 bg-white font-mono text-[11px] font-semibold text-zinc-700">03</span>
                            <h5 className="text-sm font-semibold text-zinc-950">Bỏ giỏ và trả hàng sẽ trừ điểm</h5>
                        </div>
                        <p className="mt-2 flex-1 text-xs leading-5 text-zinc-600">
                            Bỏ giỏ chỉ trừ một phần điểm; trả hàng đảo điểm mua theo đúng số lượng được trả.
                        </p>
                        <p className="mt-3 rounded-lg bg-zinc-50 px-3 py-2 text-xs text-zinc-700">
                            Bỏ giỏ <strong className="font-mono text-sm font-semibold text-zinc-950">−2</strong>
                            <span className="mx-2 text-zinc-400">·</span>
                            Trả hàng <strong className="font-mono text-sm font-semibold text-zinc-950">−8 / sản phẩm</strong>
                        </p>
                        <p className="mt-2 text-[10px] leading-4 text-zinc-500">
                            Mặc định trong <code className="text-zinc-700">RecommendationRuleService</code>; có thể ghi đè bằng <code className="text-zinc-700">RECOMMENDATION_WEIGHT_*</code>.
                        </p>
                    </article>
            ...
            <RecommendationDisclosure
                ...
                variant="flow"
            >
                <section className="rounded-xl border border-zinc-200 bg-white p-4" aria-label="Các thao tác hợp nhất candidate">
                    <RecommendationStepHeader
                        ...
                        asideContent={<span className="inline-flex w-fit shrink-0 items-center rounded-full border border-zinc-200 bg-white px-2.5 py-1 font-mono text-[10px] font-semibold text-zinc-600">productId duy nhất · tối đa 300</span>}
                        titleLevel={5}
                    />
                ...
                >
                    <li className="rounded-xl border border-zinc-200 bg-white p-3">
                        ...
                        <p className="mt-1.5 text-[11px] leading-[1.65] text-zinc-600">
                            ...
                            : nguồn lỗi hoặc không có kết quả được bỏ qua, kết
                            quả từ nguồn khác vẫn được giữ.
                        </p>
                        <p className="mt-2 border-t border-zinc-100 pt-2 text-[10px] leading-4 text-zinc-500">
                            <strong className="font-semibold text-zinc-700">
                                Đánh đổi:
                            </strong>{' '}
                            nguồn lỗi làm pool ít lựa chọn hơn, nhưng không làm
                            hỏng cả request.
                        </p>
                    </li>
                    <li className="rounded-xl border border-zinc-200 bg-white p-3">
                        ...
                        <p className="mt-1.5 text-[11px] leading-[1.65] text-zinc-600">
                            Tạo danh sách loại trừ gồm sản phẩm đang mở và tối
                            đa 3 sản phẩm tương tác gần nhất. Các nguồn lọc danh
                            sách này; union kiểm tra lại trước khi nhận món.
                        </p>
                        <p className="mt-2 border-t border-zinc-100 pt-2 text-[10px] leading-4 text-zinc-500">
                            <strong className="font-semibold text-zinc-700">
                                Đánh đổi:
                            </strong>{' '}
                            giảm gợi ý lặp, nhưng món đang mở sẽ không được đề
                            xuất lại trong request đó.
                        </p>
                    </li>
                    <li className="rounded-xl border border-zinc-200 bg-white p-3">
                        <p className="font-mono text-[10px] font-semibold tracking-[0.12em] text-zinc-400">
                        ...
                        <p className="mt-1.5 text-[11px] leading-[1.65] text-zinc-600">
                            ...
                            làm khóa Map. Nếu nhiều nguồn cùng trả một món, chỉ
                            giữ một sản phẩm; nguồn, lý do,{' '}
                            <code className="font-mono text-[10px] text-zinc-800">
                                rawScore
                            </code>{' '}
                        ...
                        <p className="mt-2 border-t border-zinc-100 pt-2 text-[10px] leading-4 text-zinc-500">
                            ...
                            không cộng điểm nguồn thành điểm cuối; ranking nhận
                            đủ dấu vết để tự chấm và giải thích.
                        </p>
                    </li>
                    <li className="rounded-xl border border-zinc-200 bg-white p-3">
                        <p className="font-mono text-[10px] font-semibold tracking-[0.12em] text-zinc-400">
                        ...
                        <p className="mt-1.5 text-[11px] leading-[1.65] text-zinc-600">
                            Nếu vượt 300, mỗi vòng lấy một món từ từng nguồn.
                            Trong nguồn đó, ưu tiên{' '}
                            <code className="font-mono text-[10px] text-zinc-800">
                                rawScore
                            </code>{' '}
                        ...
                        <p className="mt-2 border-t border-zinc-100 pt-2 text-[10px] leading-4 text-zinc-500">
                            ...
                            request nhẹ và có giới hạn, nhưng món ít ưu tiên có
                            thể bị cắt. 300 là guardrail hiện tại, chưa phải
                            ngưỡng tối ưu đã được kiểm chứng.
                        </p>
                    </li>
                </ol>
                ...
                <div aria-hidden="true" className="flex justify-center py-0.5"><ChevronDown className="size-4 text-zinc-400" /></div>

                <section className="rounded-xl border border-zinc-200 bg-white p-4" aria-label="Ví dụ hợp nhất danh sách candidate">
                    <RecommendationStepHeader number="02" eyebrow="Ví dụ minh họa" title="Nhiều nguồn có thể cùng tìm thấy một sản phẩm" description="Hợp nhất theo productId; thông tin từng nguồn vẫn được giữ để ranking sử dụng." titleLevel={5} />
                    ...
                    <div className="border-t border-zinc-200 pt-3 lg:border-l lg:border-t-0 lg:pl-4 lg:pt-0">
                        ...
                        <p className="mt-2 text-[10px] leading-4 text-zinc-500">
                            SP-01 chỉ còn một entry; ba nguồn và lý do xuất hiện
                            vẫn được lưu riêng.
                        </p>
                    </div>
                    </div>
                ...
                <section className="rounded-xl border border-zinc-200 bg-white p-4" aria-label="Đầu ra Candidate Union">
                    <RecommendationStepHeader number="03" eyebrow="Đầu ra · ranking" title="Pool candidate được bàn giao để tính điểm" description="Ứng viên chưa phải thứ hạng hiển thị; bước ranking tiếp theo mới quyết định thứ tự." titleLevel={5} />
                    <div className="mt-3 grid gap-2 border-t border-zinc-100 pt-3 md:grid-cols-3">
                        <article className="rounded-lg border border-zinc-200 bg-white p-3">
                            <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-500">Pool đầu vào</p>
                            <p className="mt-1 text-xs font-semibold text-zinc-900">Tối đa 300 productId duy nhất</p>
                            <p className="mt-1 text-[11px] leading-4 text-zinc-600">Sản phẩm đang xem và tối đa 3 sản phẩm tương tác gần nhất đã bị loại khỏi pool.</p>
                        </article>
                        <article className="rounded-lg border border-zinc-200 bg-white p-3">
                            <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-500">Dấu vết nguồn</p>
                            <p className="mt-1 text-xs font-semibold text-zinc-900">Giữ thông tin đóng góp của nguồn</p>
                            <p className="mt-1 text-[11px] leading-4 text-zinc-600">Candidate lưu nguồn tìm thấy; reasonCode và rawScore được giữ theo đóng góp, anchor được lưu khi nguồn cung cấp.</p>
                        </article>
                        <article className="rounded-lg border border-zinc-200 bg-white p-3">
                            <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-500">Bước kế tiếp</p>
                            <p className="mt-1 text-xs font-semibold text-zinc-900">Standard hoặc AI Ranking</p>
                            <p className="mt-1 text-[11px] leading-4 text-zinc-600">Ranking dùng pool candidate để tính điểm và quyết định thứ tự hiển thị; Candidate Union không cộng điểm nguồn thành điểm cuối.</p>
                        </article>
                    </div>
                </section>
            </RecommendationDisclosure>
