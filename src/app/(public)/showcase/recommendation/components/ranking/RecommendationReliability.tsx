                        ...
                        <dl className="mt-4 space-y-3 text-xs leading-5">
                            <div>
                                ...
                                <dd className="mt-0.5 text-zinc-600">
                                    Hồ sơ, phiên hiện tại, sản phẩm đang xem và
                                    các nguồn catalog/vector/hành vi.
                                </dd>
                            </div>
                            <div>
                                <dt className="font-semibold text-zinc-900">
                                ...
                                <dd className="mt-0.5 text-zinc-600">
                                    Các nguồn chạy độc lập. Nguồn rỗng hoặc lỗi
                                    bị bỏ qua; nguồn còn lại được gộp, bỏ trùng
                                    thành tối đa 300 sản phẩm chờ xếp hạng.
                                </dd>
                            </div>
                            <div className="rounded-xl border border-zinc-200 bg-white p-3 text-zinc-600">
                                ...
                                vẫn trả được gợi ý khi một nguồn lỗi, nhưng danh
                                sách có thể ít lựa chọn hơn.
                            </div>
                        </dl>
                    </article>
                    ...
                    <article className="rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5">
                        ...
                        <dl className="mt-4 space-y-3 text-xs leading-5">
                            <div>
                                ...
                                <dd className="mt-0.5 text-zinc-600">
                                    Danh sách sản phẩm chờ xếp hạng và các điểm
                                    tiêu chí đã chuẩn hóa.
                                </dd>
                            </div>
                            <div>
                                <dt className="font-semibold text-zinc-900">
                                ...
                                <dd className="mt-0.5 text-zinc-600">
                                    Standard luôn tạo điểm nền. Nếu bật AI, hệ
                                    thống chờ tối đa 150ms mặc định. Điểm AI
                                    không hợp lệ thì món đó giữ Standard; nếu
                                    lần gọi AI lỗi hoặc quá hạn, cả danh sách
                                    dùng Standard.
                                </dd>
                            </div>
                            <div className="rounded-xl border border-zinc-200 bg-white p-3 text-zinc-600">
                    ...
                    <article className="rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5">
                        ...
                        <dl className="mt-4 space-y-3 text-xs leading-5">
                            ...
                            <div>
                                ...
                                <dd className="mt-0.5 text-zinc-600">
                                    Áp quy tắc đa dạng rồi trả danh sách theo
                                    trang. Nếu API recommendation lỗi, Web dùng
                                    catalog có sẵn ở trang chủ hoặc món bán chạy
                                    ở trang chi tiết.
                                </dd>
                            </div>
                            <div className="rounded-xl border border-zinc-200 bg-white p-3 text-zinc-600">
                                ...
                                giới hạn bảo vệ tốc độ và payload, nhưng món ở
                                sâu trong danh sách có thể không được trả về.
                            </div>
                        </dl>
                    </article>
                </div>
                ...
                <div className="grid gap-3 bg-white md:grid-cols-3">
                    ...
                    <article className="rounded-2xl border border-zinc-200 bg-white p-4">
                        ...
                        <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                            ...
                            attribution hợp lệ thì event có thể còn là hành vi
                            chung, nhưng không được tính vào phép đo
                            recommendation.
                        </p>
                    </article>
                    <article className="rounded-2xl border border-zinc-200 bg-white p-4">
                        ...
                        <p className="mt-1.5 text-xs leading-5 text-zinc-600">
                            ...
                            consumer cập nhật hồ sơ sau đó. Vì xử lý bất đồng
                            bộ, event mới không làm đổi ngay danh sách đang xem.
                        </p>
                    </article>
                </div>
                <p className="mt-3 rounded-xl border border-zinc-200 bg-white px-4 py-3 text-xs leading-5 text-zinc-600">
                    <strong className="text-zinc-900">Đánh đổi:</strong> ngưỡng
                    50% tránh tính thẻ chỉ vừa ló vào màn hình là đã được thấy,
                    nhưng có thể bỏ sót lượt nhìn rất nhanh. Gửi theo lô và xử
                    lý nền giảm request/chờ đợi, đổi lại feedback cập nhật trễ.
                </p>
                </div>
            </RecommendationDisclosure>
