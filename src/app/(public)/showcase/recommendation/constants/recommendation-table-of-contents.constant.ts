                ...
                children: [
                    {
                        ...
                        label: '1.1.1 · Luồng đọc',
                    },
                    {
                        id: 'recommendation-architecture-write-flow',
                        label: '1.1.2 · Luồng ghi',
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        ...
                        label: '1.3.1 · Luồng trả gợi ý',
                    },
                    {
                        id: 'recommendation-async-services',
                        label: '1.3.2 · Dữ liệu & cập nhật nền',
                    },
                ],
            },
        ],
                ...
                children: [
                    {
                        ...
                        label: '2.1.1 · Hai lớp tín hiệu',
                    },
                    {
                        id: 'recommendation-event-weights',
                        label: '2.1.2 · Cách tính điểm hành vi',
                    },
                    {
                        ...
                        children: [
                            {
                                ...
                                label: '2.1.3.1 · Tìm theo sở thích Catalog',
                            },
                            {
                                id: 'recommendation-cold-start-flow-title',
                                label: '2.1.3.2 · Trending và cold-start',
                            },
                            {
                                id: 'recommendation-semantic-flow-title',
                                label: '2.1.3.3 · Tìm theo ngữ nghĩa',
                            },
                            {
                                id: 'recommendation-cobehavior-flow-title',
                                label: '2.1.3.4 · Tìm theo quan hệ hành vi',
                            },
                        ],
                    },
                    {
                        id: 'recommendation-candidate-union',
                        label: '2.1.4 · Hợp nhất candidate',
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        ...
                        label: '2.2.1 · Công thức Standard',
                    },
                    {
                        ...
                        children: [
                            {
                                id: 'ranking-feature-profileAffinity',
                                label: '2.2.2.1 · Sở thích trong hồ sơ',
                            },
                            {
                                id: 'ranking-feature-sessionContext',
                                label: '2.2.2.2 · Nhu cầu trong phiên hiện tại',
                            },
                            {
                                id: 'ranking-feature-semanticSimilarity',
                                label: '2.2.2.3 · Sản phẩm tương tự về nội dung',
                            },
                            {
                                id: 'ranking-feature-coBehavior',
                                label: '2.2.2.4 · Sản phẩm thường đi cùng nhau',
                            },
                            {
                                id: 'ranking-feature-popularity',
                                label: '2.2.2.5 · Mức độ phổ biến',
                            },
                            {
                                id: 'ranking-feature-freshness',
                                label: '2.2.2.6 · Độ mới của sản phẩm',
                            },
                            {
                                id: 'ranking-feature-quality',
                                label: '2.2.2.7 · Chất lượng và tồn kho',
                            },
                            {
                                id: 'ranking-feature-exploration',
                                label: '2.2.2.8 · Khám phá sản phẩm mới',
                            },
                        ],
                    },
                    {
                ...
                children: [
                    {
                        ...
                        label: '2.3.1 · Dự phòng theo bước',
                    },
                    {
                        id: 'recommendation-feedback-flow',
                        label: '2.3.2 · Ghi nhận tương tác',
                    },
                ],
            },
        ],
