...
function readStage(value: string | null): CustomerOrderStage | undefined {
    return [
        'TO_SHIP',
        'SHIPPING',
        'COMPLETED',
...
export default function ProfileOrdersPage() {
    ...
    const ordersQuery = useCustomerOrders(stage, page);
    ...
    function navigate(
        nextStage: CustomerOrderStage | undefined,
        nextPage = 1,
    ): void {
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
            <div className="flex flex-col gap-6 md:flex-row md:gap-8">
                ...
                <main className="min-w-0 flex-1">
                    ...
                    <CustomerOrderTabs
                        activeStage={stage}
                        onChange={(nextStage) => navigate(nextStage)}
                    />
