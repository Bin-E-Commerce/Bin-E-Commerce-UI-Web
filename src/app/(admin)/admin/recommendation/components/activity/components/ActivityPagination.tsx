...
export function ActivityPagination({ page, pageSize, total, onPageChange }: Props) {
    ...
    return (
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-zinc-100 px-5 py-3 text-xs text-zinc-500">
            <span>
                Hiển thị {((page - 1) * pageSize) + 1}–{Math.min(page * pageSize, total)} trong tổng số {total} activity
            </span>
            {pageCount > 1 ? (
