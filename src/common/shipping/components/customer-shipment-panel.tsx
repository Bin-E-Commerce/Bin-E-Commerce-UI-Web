...
export function CustomerShipmentPanel({
    orderId,
    orderStage,
}: CustomerShipmentPanelProps) {
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h2 className="font-semibold text-red-950">
                            Tracking đang tạm thời gián đoạn
                        </h2>
                        <p className="mt-1 text-sm leading-6 text-red-800">
                            Chi tiết đơn vẫn an toàn. Hãy thử tải lại hành trình
                            sau ít phút.
                        </p>
                        <Button
                            type="button"
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h2 className="font-semibold text-zinc-950">
                            Shop đang chuẩn bị vận chuyển
                        </h2>
                        <p className="mt-1 text-sm leading-6 text-zinc-500">
                            Thông tin mã vận đơn và bản đồ sẽ xuất hiện ngay khi
                            shop tạo vận đơn.
                        </p>
                    </div>
                </div>
