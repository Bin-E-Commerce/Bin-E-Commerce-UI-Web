...
import type { ApiResponse, AuthData, LoginPayload } from '../types/auth.types';
...
// Khôi phục phiên bằng httpOnly refresh_token cookie để người dùng không phải đăng nhập lại.
