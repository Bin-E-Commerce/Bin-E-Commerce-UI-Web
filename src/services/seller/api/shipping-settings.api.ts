...
export function getShippingSettings(): Promise<ShippingSettingsResponse> {
    return authorizedAxios
        .get<ShippingSettingsResponse>(
            `${API_VERSION}/seller/shipping/settings`,
        )
...
export function updateShippingSettings(
    payload: Partial<ShippingSettingsResponse['settings']>,
): Promise<ShippingSettingsResponse> {
    return authorizedAxios
        .patch<ShippingSettingsResponse>(
            `${API_VERSION}/seller/shipping/settings`,
            payload,
        )
        .then((response) => response.data);
...
export function createPickupAddress(
    payload: PickupAddressPayload,
): Promise<ShippingSettingsResponse> {
    return authorizedAxios
        .post<ShippingSettingsResponse>(
            `${API_VERSION}/seller/shipping/pickup-addresses`,
            payload,
        )
        .then((response) => response.data);
}
...
export function setDefaultPickupAddress(
    id: string,
): Promise<ShippingSettingsResponse> {
    return authorizedAxios
        .post<ShippingSettingsResponse>(
            `${API_VERSION}/seller/shipping/pickup-addresses/${id}/default`,
        )
        .then((response) => response.data);
}
...
export function updatePickupAddress(
    ...
    return authorizedAxios
        .patch<ShippingSettingsResponse>(
            `${API_VERSION}/seller/shipping/pickup-addresses/${id}`,
            payload,
        )
        .then((response) => response.data);
}
...
export function deletePickupAddress(
    id: string,
): Promise<ShippingSettingsResponse> {
    return authorizedAxios
        .delete<ShippingSettingsResponse>(
            `${API_VERSION}/seller/shipping/pickup-addresses/${id}`,
        )
        .then((response) => response.data);
}
